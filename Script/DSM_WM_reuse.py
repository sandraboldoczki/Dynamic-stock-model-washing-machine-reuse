...
for e in range (Par_NoOfEEC):
    Def_EECName.append(Pro_DefSheet.cell_value(e+2,0)) ##cell_value(row_num,col_num), starting with 0
    Def_EECCode.append(Pro_DefSheet.cell_value(e+2,1))
...
Pro_ParSheet = Pro_DataFileWB.sheet_by_name('Lifespan')

e = 0

Par_Lifetime_New = Pro_ParSheet.cell_value(e+2,0)
Par_Lifetime_Reuse = Pro_ParSheet.cell_value(e+2,1)
Par_LTNew_Shape  = Pro_ParSheet.cell_value(e+2,2)
Par_LTReuse_Shape  = Pro_ParSheet.cell_value(e+2,3)

##Read demand parameters
Pro_DemSheet = Pro_DataFileWB.sheet_by_name('In-use-stock')
...
for t in range (0, Par_NoOfYears):
   Par_DemandbyYear [t] = Pro_DemSheet.cell_value(t+3,1)
   for e in range (0, Par_NoOfEEC):
       Par_DemandbyPercent [t,e] = Pro_DemSheet.cell_value(t+3,e+2)
...
for s in range (0, Par_NoOfEEC):
    Par_InitialStock[s] = Pro_StockSheet.cell_value (s+2,1)
...
#%%
    ...
    for f in range (Par_NoOfImpactCat):
        Def_ImpactCatName.append(Pro_DefSheetLCA.cell_value(f+2,0)) #cell_value(row_num,col_num), starting with 0
        Def_ImpactCatCode.append(Pro_DefSheetLCA.cell_value(f+2,1))
    ...
    for e in range (Par_NoOfEEC):
        Def_DemandWater.append(Pro_DemandWE.cell_value(2,e+2)) #cell_value(row_num,col_num), starting with 0
        Def_DemandElectricity.append(Pro_DemandWE.cell_value(3,e+2))
        Def_DemandProduction.append(Pro_DemandWE.cell_value(5,e+2))
        Def_DemandRecycling.append(Pro_DemandWE.cell_value(6,e+2)) 
